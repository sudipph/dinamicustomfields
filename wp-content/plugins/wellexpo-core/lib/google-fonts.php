<?php
if ( ! function_exists( 'wellexpo_select_init_google_fonts_array' ) ) {
    function wellexpo_select_init_google_fonts_array() {
        ...
        $wellexpo_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'wellexpo_select_init_google_fonts_array');
}