...
if ( ! function_exists( 'wellexpo_select_get_hide_dep_for_header_main_menu_options' ) ) {
	function wellexpo_select_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'wellexpo_select_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'wellexpo_select_header_main_navigation_options_map' ) ) {
	function wellexpo_select_header_main_navigation_options_map() {
		$hide_dep_options = wellexpo_select_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = wellexpo_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'wellexpo' ),
		...
		wellexpo_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'wellexpo' )
			)
		);
		...
		$drop_down_group = wellexpo_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'wellexpo' )
			)
		);
		
		$drop_down_row1 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'wellexpo' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'wellexpo' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'wellexpo' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'wellexpo' )
				)
			)
		);
		...
		$first_level_group = wellexpo_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'wellexpo' )
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'wellexpo' ),
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'wellexpo' ),
			)
		);
		
		$first_level_row4 = wellexpo_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'wellexpo' ),
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'wellexpo' ),
			)
		);
		
		$first_level_row5 = wellexpo_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = wellexpo_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = wellexpo_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = wellexpo_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'wellexpo' )
			)
		);
		...
		$second_level_wide_group = wellexpo_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'wellexpo' )
			)
		);
		
		$second_level_wide_row1 = wellexpo_select_add_admin_row(
			array(
		...
		$second_level_wide_row2 = wellexpo_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = wellexpo_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = wellexpo_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'wellexpo' )
			)
		);
		...
		$third_level_wide_group = wellexpo_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'wellexpo' )
			)
		);
		
		$third_level_wide_row1 = wellexpo_select_add_admin_row(
			array(
		...
		$third_level_wide_row2 = wellexpo_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = wellexpo_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'wellexpo_select_action_header_main_navigation_options_map', 'wellexpo_select_header_main_navigation_options_map', 10, 1 );
}