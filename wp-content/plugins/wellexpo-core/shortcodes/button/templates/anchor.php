<a itemprop="url" href="<?php echo esc_url($link); ?>" target="<?php echo esc_attr($target); ?>" <?php wellexpo_select_inline_style($button_styles); ?> <?php wellexpo_select_class_attribute($button_classes); ?> <?php echo wellexpo_select_get_inline_attrs($button_data); ?> <?php echo wellexpo_select_get_inline_attrs($button_custom_attrs); ?>>
