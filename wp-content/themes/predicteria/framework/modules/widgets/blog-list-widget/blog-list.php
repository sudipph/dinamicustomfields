...
class WellExpoSelectClassBlogListWidget extends WellExpoSelectClassWidget {
	public function __construct() {
		parent::__construct(
			'qodef_blog_list_widget',
			esc_html__( 'Predicteria Blog List Widget', 'wellexpo' ),
			array( 'description' => esc_html__( 'Display a list of your blog posts', 'wellexpo' ) )
		);
		...
		$this->params = array(
			...
			array(
				...
				'options' => array(
					...
					'minimal' => esc_html__( 'Minimal', 'wellexpo' )
				)
			),
			array(
				'type'  => 'textfield',
				'name'  => 'number_of_posts',
				'title' => esc_html__( 'Number of Posts', 'wellexpo' )
			),
			array(
				'type'    => 'dropdown',
			...
			array(
				'type'    => 'dropdown',
				'name'    => 'orderby',
				'title'   => esc_html__( 'Order By', 'wellexpo' ),
				'options' => wellexpo_select_get_query_order_by_array()
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'order',
				'title'   => esc_html__( 'Order', 'wellexpo' ),
				'options' => wellexpo_select_get_query_order_array()
			),
			array(
				'type'        => 'textfield',
				'name'        => 'category',
				'title'       => esc_html__( 'Category Slug', 'wellexpo' ),
				'description' => esc_html__( 'Leave empty for all or use comma for list', 'wellexpo' )
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'title_tag',
			...
			array(
				...
				'title'   => esc_html__( 'Title Text Transform', 'wellexpo' ),
				'options' => wellexpo_select_get_text_transform_array( true )
			),
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$instance['custom_image_width']  = '67px';
		$instance['custom_image_height'] = '47px';
		...
		echo '<div class="widget qodef-blog-list-widget" ' . wellexpo_select_get_inline_style( $widget_styles ) . '>';
