...
if ( ! function_exists( 'wellexpo_select_add_font_awesome_icon_pack' ) ) {
	function wellexpo_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new WellExpoSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_font_awesome_icon_pack_option' ) ) {
	function wellexpo_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_font_awesome_icon_pack_option' );
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_social_options', 'wellexpo_select_add_font_awesome_icon_pack_option' );
}

class WellExpoSelectClassIconsFontAwesome implements iWellExpoSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
