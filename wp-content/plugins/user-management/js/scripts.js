...
$(document).on("click", "#organizer_sponsors_submit_2", function (event) {

    var that = this;
    // jQuery(this).closest('div.add_sponsors_loading').addClass('overlay');
    var selected_sponsors = jQuery('#sponsors_user_id').val();
    var sponsor_post_id = jQuery('#sponsor_post_id').val();
    ...
    if (selected_sponsors != '') {
        ...
        jQuery.ajax({
            ...
            type: "post",
            data: {
                action: "ajax_sponsors_textarea2",
            ...
            success: function (result) {
                ...
                if (result) {
                    ...
                    jQuery('#css3_animated_slider_sponsors_list').append(result.htmlimage);
...
function remove_field_editor_box2(vart, id, post_id) {
    jQuery.ajax({
        url: ajax_url,
        type: "post",
        data: {
            action: "ajax_sponsors_remove",
            post_key: id,
            post_id: post_id
        },
        dataType: "json",
