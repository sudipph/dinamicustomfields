...
if ( ! function_exists( 'wellexpo_select_add_simple_line_icon_pack' ) ) {
	function wellexpo_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new WellExpoSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_simple_line_icon_pack_option' ) ) {
	function wellexpo_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_simple_line_icon_pack_option' );
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_social_options', 'wellexpo_select_add_simple_line_icon_pack_option' );
}

class WellExpoSelectClassSimpleLineIcons implements iWellExpoSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'wellexpo'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'wellexpo'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'wellexpo'),
            'icon-social-facebook'    => esc_html__('Facebook', 'wellexpo'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'wellexpo'),
            'icon-social-github'      => esc_html__('Github', 'wellexpo'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'wellexpo'),
            'icon-social-instagram'   => esc_html__('Instagram', 'wellexpo'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'wellexpo'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'wellexpo'),
            'icon-social-reddit'      => esc_html__('Reddit', 'wellexpo'),
            'icon-social-skype'       => esc_html__('Skype', 'wellexpo'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'wellexpo'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'wellexpo'),
            'icon-social-spotify'     => esc_html__('Spotify', 'wellexpo'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'wellexpo'),
            'icon-social-twitter'     => esc_html__('Twitter', 'wellexpo'),
            'icon-social-youtube'     => esc_html__('Youtube', 'wellexpo')
        );
    }
