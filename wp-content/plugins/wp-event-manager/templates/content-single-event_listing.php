<div class="event-details-header">
   <ul>
	<li><a href="#summit_details">Summit Details</a></li>
	<li><a href="#">Program</a></li>
	<li><a href="#">Venue</a></li>
	<li><a href="#">Sponsor</a></li>
	<li class="details_reg"><a href="#">Register</a></li>
	</ul>
</div>
...
<div class="single_event_listing" id="summit_details" itemscope itemtype="http://schema.org/EventPosting">
   ...
   <?php 
	...
	</div>	<div class="d-exe-board-speaker-outer">		<div class="executive-board-page-outer">			<?php include('executtive_board.php');?>		</div>		<div class="executive-board-page-outer speaker-keynote">			<?php include('speaker_list.php');?>		</div>		<div class="executive-board-page-outer speaker-our-list">			<?php include('our-speaker.php');?>		</div>	</div>	<div class="d-exe-board-summit-venue">		<?php include('summit_venue.php');?>	</div>	<div class="d-exe-board-summit-speaker-outer">		<div class="d-exe-board-summit-speaker-outer-inner">			<div class="d-summit-sponsor-outer platinum-sponsor">				
	<?php 
	//do_action('sponsors_loop');
	include('palatinum_sponsor_list.php');?>			</div>			<div class="d-summit-sponsor-outer diamond-sponsor">				<?php include('diamond_sponsor.php');?>			</div>		</div>	</div>	<div class="still-have-question-outer">		<?php include('still_have_question.php');?>	</div>
	<?php
    /**
