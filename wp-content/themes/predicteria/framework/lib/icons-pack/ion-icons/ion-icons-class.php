...
if ( ! function_exists( 'wellexpo_select_add_ion_icon_pack' ) ) {
	function wellexpo_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new WellExpoSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_ion_icon_pack_option' ) ) {
	function wellexpo_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_ion_icon_pack_option' );
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_social_options', 'wellexpo_select_add_ion_icon_pack_option' );
}

class WellExpoSelectClassIonIcons implements iWellExpoSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
