...
if ( $row_content_width !== 'grid' ) {
	...
	if ( ! empty( $background_image_fixed_position ) && $background_image_fixed_position === 'yes' ) {
...
if ( !empty($bg_text) ) { 
	...
	$qodef_bg_text_html = '<div class="qodef-row-bg-text-holder '.esc_attr( $bg_text_alignment ).'">';
	$qodef_bg_text_html .= '<div class="qodef-row-bg-text-inner">';
	$qodef_bg_text_html .= '<span class="qodef-row-bg-text">'.esc_attr($bg_text).'</span>';
