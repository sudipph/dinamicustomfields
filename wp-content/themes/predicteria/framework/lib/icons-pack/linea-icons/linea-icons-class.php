...
if ( ! function_exists( 'wellexpo_select_add_linea_icon_pack' ) ) {
	function wellexpo_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new WellExpoSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_linea_icon_pack_option' ) ) {
	function wellexpo_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_linea_icon_pack_option' );
}

class WellExpoSelectClassLineaIcons implements iWellExpoSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
