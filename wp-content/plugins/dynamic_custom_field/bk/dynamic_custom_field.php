                ...
                <div class="field_left" style="width: 60%;    padding-left: 10px;">
                    ...
                    ?>
                        <div class="content_box_children">
                            ...
                            input_html('location','Location :',$rand_number,$location);
...
$result_for_search  = find_selected_item_from_array($search_content_arr,$full_gallery_data_arr,$pid);

if(isset($search_content_arr) && count($search_content_arr)>0){
								...
								<div class="agenda_list_inner">
									<div class="left">
										<ul>
											...
											<li class="a_loction"><?php echo $location;?></li>
...
function find_selected_item_from_array($search_content_arr='',$full_gallery_data_arr,$pid){
    $topic = [];
    $return_result = [];
