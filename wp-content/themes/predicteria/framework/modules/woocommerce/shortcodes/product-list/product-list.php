...
namespace WellExpoCore\CPT\Shortcodes\ProductList;
...
class ProductList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List', 'wellexpo' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Product Info Position', 'wellexpo' ),
							'value'       => array(
								esc_html__( 'Info On Image Hover', 'wellexpo' ) => 'info-on-image',
								esc_html__( 'Info Below Image', 'wellexpo' )    => 'info-below-image'
							),
							'save_always' => true
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Skin', 'wellexpo' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Text Alignment', 'wellexpo' ),
							'value'      => array(
								esc_html__( 'Default', 'wellexpo' ) => '',
						...
						array(
							...
							'heading'    => esc_html__( 'Product Info Bottom Margin (px)', 'wellexpo' ),
							'dependency' => array( 'element' => 'info_position', 'value'   => array( 'info-below-image' ) ),
							'group'      => esc_html__( 'Product Info Style', 'wellexpo' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = wellexpo_select_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list', $params['type'], $params, $additional_params );
	...
	public function getTextWrapperStyles( $params ) {
		...
		if ( $params['info_bottom_margin'] !== '' ) {
			$styles[] = 'margin-bottom: ' . wellexpo_select_filter_px( $params['info_bottom_margin'] ) . 'px';
		}
