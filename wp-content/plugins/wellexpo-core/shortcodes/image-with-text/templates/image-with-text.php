<div class="qodef-image-with-text-holder <?php echo esc_attr($holder_classes); ?>">
    ...
    <div class="qodef-iwt-text-holder">
        <?php if(!empty($text)) { ?>
            <p class="qodef-iwt-text" <?php echo wellexpo_select_get_inline_style($text_styles); ?>><?php echo esc_html($text); ?></p>
        <?php } ?>
        <?php if(!empty($title)) { ?>
           <?php if ($image_behavior === 'custom-link' && !empty($custom_link)) { ?>
	            <a itemprop="url" href="<?php echo esc_url($custom_link); ?>" target="<?php echo esc_attr($custom_link_target); ?>">
            <?php } ?>
                <<?php echo esc_attr($title_tag); ?> class="qodef-iwt-title" <?php echo wellexpo_select_get_inline_style($title_styles); ?>><?php echo esc_html($title); ?></<?php echo esc_attr($title_tag); ?>>
            <?php if ($image_behavior === 'custom-link' && !empty($custom_link)) { ?>
                </a>
            <?php } ?>
        <?php } ?>
