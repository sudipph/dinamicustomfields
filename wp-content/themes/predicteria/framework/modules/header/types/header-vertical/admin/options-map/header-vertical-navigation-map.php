...
if ( ! function_exists( 'wellexpo_select_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function wellexpo_select_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'wellexpo_select_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'wellexpo_select_header_vertical_navigation_options_map' ) ) {
	function wellexpo_select_header_vertical_navigation_options_map() {
		$hide_dep_options = wellexpo_select_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = wellexpo_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'wellexpo' ),
		...
		$drop_down_group = wellexpo_select_add_admin_group(
			array(
				'parent'      => $panel_vertical_main_menu,
				'name'        => 'vertical_drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'wellexpo' ),
				'description' => esc_html__( 'Set a style for dropdown menu', 'wellexpo' )
			)
		);
		
		$vertical_drop_down_row1 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'wellexpo' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'wellexpo'),
					'side' => esc_html__('On Side', 'wellexpo'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = wellexpo_select_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'wellexpo' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'wellexpo' ),
				'parent'        => $row_vertical_first_level_1
			)
		);
		...
		$row_vertical_first_level_2 = wellexpo_select_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = wellexpo_select_add_admin_row(
			array(
		...
		$group_vertical_second_level = wellexpo_select_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'wellexpo' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = wellexpo_select_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = wellexpo_select_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = wellexpo_select_add_admin_row(
			array(
		...
		$group_vertical_third_level = wellexpo_select_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'wellexpo' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = wellexpo_select_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = wellexpo_select_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = wellexpo_select_add_admin_row(
			array(
	...
	add_action( 'wellexpo_select_action_additional_header_main_navigation_options_map', 'wellexpo_select_header_vertical_navigation_options_map', 10, 1 );
}