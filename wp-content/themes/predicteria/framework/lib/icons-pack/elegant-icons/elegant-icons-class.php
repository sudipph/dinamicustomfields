...
if ( ! function_exists( 'wellexpo_select_add_font_elegant_icon_pack' ) ) {
	function wellexpo_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new WellExpoSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_font_elegant_icon_pack_option' ) ) {
	function wellexpo_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_font_elegant_icon_pack_option' );
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_social_options', 'wellexpo_select_add_font_elegant_icon_pack_option' );
}

class WellExpoSelectClassIconsFontElegant implements iWellExpoSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
