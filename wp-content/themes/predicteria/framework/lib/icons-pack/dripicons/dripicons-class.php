...
if ( ! function_exists( 'wellexpo_select_add_dripicons_icon_pack' ) ) {
	function wellexpo_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new WellExpoSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_dripicons_icon_pack_option' ) ) {
	function wellexpo_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_dripicons_icon_pack_option' );
}

class WellExpoSelectClassDripicons implements iWellExpoSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
