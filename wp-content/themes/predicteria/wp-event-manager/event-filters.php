...
<div class="left_panel_event_search">
	<form class="event_filters" id="event_filters">
		<div class="filter-title">Filter Summits</div>
		...
		<?php do_action( 'event_manager_event_filters_search_events_start', $atts ); ?>
			<div class="row">
				...
				<div class="col-sm-12">
					...
					<label for="search_location"><?php _e( 'State', 'wp-event-manager' ); ?></label>
					...
					<?php 
					echo wp_dropdown_categories( array('hierarchical'=>0, 'taxonomy' => 'location', 'hide_empty' => 0, 'name' => "search_location", 'selected' => '', 'orderby' => 'name', 'hierarchical' => 1,'parent' =>0, 'show_option_none' => '&mdash;Select State &mdash;','class'=>'search_by_location_sub_location','echo'=>false,'depth'=>0,'child_of'=>0,'value_field'=> 'slug','option_none_value'  => '' ) );
					?>
				</div>

				<div class="col-sm-12">
				
					<label for="search_location"><?php _e( 'City', 'wp-event-manager' ); ?></label>
					<div id="result_city_list_from_location">
					<select name="search_city" id="search_city" class="search_by_location_sub_city">
			...
			<div class="row">
				...
				<?php elseif ( $show_categories && ! is_tax( 'event_listing_category' ) && get_terms( 'event_listing_category' ) ) : ?>
					<div class="col-sm-12">
						<label for="search_categories"><?php _e( 'Industry', 'wp-event-manager' ); ?></label>
						...
						<?php else : ?>
							<?php event_manager_dropdown_selection( array( 'taxonomy' => 'event_listing_category', 'hierarchical' => 1, 'show_option_all' => __( 'Any Industry', 'wp-event-manager' ), 'name' => 'search_categories', 'orderby' => 'name', 'selected' => $selected_category, 'multiple' => false, 'hide_empty' => false) ); ?>
						<?php endif; ?>
					</div>
				<?php endif; ?>	 
				...
				<?php elseif ( $show_event_types && ! is_tax( 'event_listing_type' ) && get_terms( 'event_listing_type' ) ) : ?>		
					<div class="col-sm-12">
						<label for="search_event_types"><?php _e( 'Topics', 'wp-event-manager' ); ?></label>
						...
						<?php else : ?>
							<?php event_manager_dropdown_selection( array( 'taxonomy' => 'event_listing_type', 'hierarchical' => 1, 'show_option_all' => __( 'Any Event Topics', 'wp-event-manager' ), 'name' => 'search_event_types', 'orderby' => 'name', 'selected' => $selected_event_type, 'multiple' => false,'hide_empty' => false) ); ?>
						<?php endif; ?>
					</div>
				<?php endif; ?>		        
