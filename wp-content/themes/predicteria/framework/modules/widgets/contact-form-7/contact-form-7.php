...
class WellExpoSelectClassContactForm7Widget extends WellExpoSelectClassWidget {
	public function __construct() {
		parent::__construct(
			'qodef_contact_form_7_widget',
			esc_html__( 'Predicteria Contact Form 7 Widget', 'wellexpo' ),
			array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'wellexpo' ) )
		);
	...
	protected function setParams() {
		...
		$this->params = array(
			array(
				'type'  => 'textfield',
				'name'  => 'extra_class',
				'title' => esc_html__( 'Extra Class Name', 'wellexpo' )
			),
			array(
				'type'  => 'textfield',
			...
			array(
				'type'    => 'dropdown',
				'name'    => 'contact_form',
				'title'   => esc_html__( 'Select Contact Form 7', 'wellexpo' ),
				'options' => $contact_forms
			),
			array(
				'type'    => 'dropdown',
				'name'    => 'contact_form_style',
				'title'   => esc_html__( 'Contact Form 7 Style', 'wellexpo' ),
				'options' => array(
	...
	public function widget( $args, $instance ) {
		...
		?>
		<div class="widget qodef-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo wellexpo_select_get_inline_style( $widget_styles ); ?>>
