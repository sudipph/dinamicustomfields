...
if ( ! function_exists('wellexpo_select_contact_form_7_options_map') ) {

	function wellexpo_select_contact_form_7_options_map() {
		
		wellexpo_select_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'wellexpo' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = wellexpo_select_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'wellexpo' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'wellexpo' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'wellexpo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'wellexpo' ),
			)
		);
		...
		$typography_text_row2 = wellexpo_select_add_admin_row(
			array(
		...
		$typography_text_row3 = wellexpo_select_add_admin_row(
			array(
		...
		$typography_label_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'wellexpo' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'wellexpo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = wellexpo_select_add_admin_row(
			array(
		...
		$typography_label_row2 = wellexpo_select_add_admin_row(
			array(
		...
		$background_border_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'wellexpo' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'wellexpo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'wellexpo' )
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'wellexpo' )
			)
		);
		
		$background_border_row2 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'wellexpo' ),
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'wellexpo' )
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'wellexpo' )
			)
		);
		
		$background_border_row3 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'wellexpo' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = wellexpo_select_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'wellexpo' ),
				'description' => esc_html__( 'Setup form elements margin', 'wellexpo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = wellexpo_select_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'wellexpo' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'wellexpo' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'wellexpo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'wellexpo' ),
				'description' => esc_html__( 'Setup button text typography', 'wellexpo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = wellexpo_select_add_admin_row(
			array(
		...
		$button_typography_row2 = wellexpo_select_add_admin_row(
			array(
		...
		$button_background_border_group = wellexpo_select_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'wellexpo' ),
				'description' => esc_html__( 'Setup button background and border style', 'wellexpo' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'wellexpo' )
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'wellexpo' )
			)
		);
		
		$button_background_border_row2 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'wellexpo' )
			)
		);
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'wellexpo' )
			)
		);
		
		$button_background_border_row3 = wellexpo_select_add_admin_row(
			array(
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'wellexpo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		wellexpo_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'wellexpo' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = wellexpo_select_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'wellexpo')
		));

		//Text Typography

		$typography_text_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'wellexpo'),
			'description'	=> esc_html__('Setup typography for form elements text', 'wellexpo'),
		...
		$typography_text_row1 = wellexpo_select_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = wellexpo_select_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = wellexpo_select_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'wellexpo'),
			'description'	=> esc_html__('Setup typography for form elements label', 'wellexpo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = wellexpo_select_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = wellexpo_select_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'wellexpo'),
			'description'	=> esc_html__('Setup form elements background and border style', 'wellexpo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = wellexpo_select_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = wellexpo_select_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = wellexpo_select_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'wellexpo'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = wellexpo_select_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'wellexpo'),
			'description'	=> esc_html__('Setup form elements margin', 'wellexpo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = wellexpo_select_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'wellexpo'),
			'description'	=> esc_html__('Setup button text typography', 'wellexpo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = wellexpo_select_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = wellexpo_select_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = wellexpo_select_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'wellexpo'),
			'description'	=> esc_html__('Setup button background and border style', 'wellexpo'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = wellexpo_select_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = wellexpo_select_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = wellexpo_select_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = wellexpo_select_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'wellexpo')
        ));
        ...
        $typography_label_row3 = wellexpo_select_add_admin_row(array(
        ...
        $button_typography_row3 = wellexpo_select_add_admin_row(array(
	...
	add_action( 'wellexpo_select_action_options_map', 'wellexpo_select_contact_form_7_options_map', wellexpo_select_set_options_map_position( 'contact_form_7' ) );
}