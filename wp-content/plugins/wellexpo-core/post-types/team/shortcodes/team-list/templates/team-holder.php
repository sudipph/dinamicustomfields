<div class="qodef-team-list-holder qodef-grid-list qodef-disable-bottom-space <?php echo esc_attr($holder_classes); ?>" <?php echo wellexpo_select_get_inline_attrs($data_attrs); ?>>
