...
if ( ! function_exists('wellexpo_select_breadcrumbs_title_type_options_map') ) {
	function wellexpo_select_breadcrumbs_title_type_options_map($panel_typography) {
		
		wellexpo_select_add_admin_section_title(
			array(
				'name'   => 'type_section_breadcrumbs',
				'title'  => esc_html__( 'Breadcrumbs', 'wellexpo' ),
				'parent' => $panel_typography
			)
		);
	
		$group_page_breadcrumbs_styles = wellexpo_select_add_admin_group(
			array(
				'name'        => 'group_page_breadcrumbs_styles',
				'title'       => esc_html__( 'Breadcrumbs', 'wellexpo' ),
				'description' => esc_html__( 'Define styles for page breadcrumbs', 'wellexpo' ),
				'parent'      => $panel_typography
			)
		);
	
			$row_page_breadcrumbs_styles_1 = wellexpo_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_2 = wellexpo_select_add_admin_row(
				array(
			...
			$row_page_breadcrumbs_styles_3 = wellexpo_select_add_admin_row(
				array(
	...
	add_action( 'wellexpo_select_action_additional_title_typography_options_map', 'wellexpo_select_breadcrumbs_title_type_options_map');
}