...
if ( ! function_exists( 'wellexpo_select_add_linear_icon_pack' ) ) {
	function wellexpo_select_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new WellExpoSelectClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_collection', 'wellexpo_select_add_linear_icon_pack' );
}

if ( ! function_exists( 'wellexpo_select_add_linear_icon_pack_option' ) ) {
	function wellexpo_select_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'wellexpo' );
		
		return $options;
	}
	
	add_filter( 'wellexpo_select_filter_add_icon_pack_into_options', 'wellexpo_select_add_linear_icon_pack_option' );
}

class WellExpoSelectClassLinearIcons implements iWellExpoSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
